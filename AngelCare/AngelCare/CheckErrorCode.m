...
+(void)Check_Error:(NSString *)ErrorData WithSender:(id)sender
{
    ...
    switch (ErrorValue)
    {
        case 1:
            ...
            alert = [[UIAlertView alloc] initWithTitle:NSLocalizedStringFromTable(@"ALERT_MESSAGE_TITLE", INFOPLIST, nil) message:NSLocalizedStringFromTable(@"ErrorCode_01", INFOPLIST, nil) delegate:sender cancelButtonTitle:NSLocalizedStringFromTable(@"ALERT_MESSAGE_CLOSE", INFOPLIST, nil) otherButtonTitles: nil];
            [alert setTag:1];
        ...
        case 2:
            ...
            alert = [[UIAlertView alloc] initWithTitle:NSLocalizedStringFromTable(@"ALERT_MESSAGE_TITLE", INFOPLIST, nil) message:NSLocalizedStringFromTable(@"ErrorCode_02", INFOPLIST, nil) delegate:sender cancelButtonTitle:NSLocalizedStringFromTable(@"ALERT_MESSAGE_CLOSE", INFOPLIST, nil) otherButtonTitles: nil];
            [alert setTag:2];
            [alert show];
            break;
            
        case 3:
            alert = [[UIAlertView alloc] initWithTitle:NSLocalizedStringFromTable(@"ALERT_MESSAGE_TITLE", INFOPLIST, nil) message:NSLocalizedStringFromTable(@"ErrorCode_03", INFOPLIST, nil) delegate:sender cancelButtonTitle:NSLocalizedStringFromTable(@"ALERT_MESSAGE_CLOSE", INFOPLIST, nil) otherButtonTitles:NSLocalizedStringFromTable(@"ALERT_MESSAGE_RESEND", INFOPLIST, nil), nil];
            [alert setTag:3];
            [alert show];
            break;
        ...
        case 4:
            alert = [[UIAlertView alloc] initWithTitle:NSLocalizedStringFromTable(@"ALERT_MESSAGE_TITLE", INFOPLIST, nil) message:NSLocalizedStringFromTable(@"ErrorCode_04", INFOPLIST, nil) delegate:sender cancelButtonTitle:NSLocalizedStringFromTable(@"ALERT_MESSAGE_CLOSE", INFOPLIST, nil) otherButtonTitles: nil];
            [alert setTag:4];
            [alert show];
            break;
        
        case 5:
            alert = [[UIAlertView alloc] initWithTitle:NSLocalizedStringFromTable(@"ALERT_MESSAGE_TITLE", INFOPLIST, nil) message:NSLocalizedStringFromTable(@"ErrorCode_05", INFOPLIST, nil) delegate:sender cancelButtonTitle:NSLocalizedStringFromTable(@"ALERT_MESSAGE_CLOSE", INFOPLIST, nil) otherButtonTitles: nil];
            [alert setTag:5];
            [alert show];
            break;
