...
- (void)minimizeLabelFrameWithMaximumSize:(CGSize)maxSize adjustHeight:(BOOL)adjustHeight {
    if (self.subLabel.text != nil) {
        ...
        if ([[[UIDevice currentDevice] systemVersion]intValue] < 7){
            ...
            //iOS 7 related work
            //ios7 modify
            NSDictionary *attributes = @{NSFontAttributeName: self.subLabel.font};
            // NSString class method: boundingRectWithSize:options:attributes:context is
            // available only on ios7.0 sdk.
            CGRect rect = [self.subLabel.text boundingRectWithSize:maxSize
                                                           options:NSStringDrawingUsesLineFragmentOrigin
                                                        attributes:attributes
                                                           context:nil];
            minimumLabelSize = rect.size;
...
- (CGSize)subLabelSize {
    ...
    if ([[[UIDevice currentDevice] systemVersion]intValue] < 7){
        ...
        // NSString class method: boundingRectWithSize:options:attributes:context is
        // available only on ios7.0 sdk.
        CGRect rect = [self.subLabel.text boundingRectWithSize:maximumLabelSize
                                                       options:NSStringDrawingUsesLineFragmentOrigin
                                                    attributes:attributes
                                                       context:nil];
